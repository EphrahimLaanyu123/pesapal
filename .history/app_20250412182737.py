...
def initiate_payment():
    ...
    try:
        ...
        # HTTP errors (like 4xx, 5xx)
        return jsonify({'error': 'HTTP error occurred during authentication', 'details': str(http_err), 'response': auth_response.text}), 500
    except requests.exceptions.RequestException as err:
        # Other request-related errors
        return jsonify({'error': 'Request error occurred during authentication', 'details': str(err)}), 500
