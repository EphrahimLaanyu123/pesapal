...
BEARER_TOKEN = os.getenv('BEARER_TOKEN', 'YOUR_ACCESS_TOKEN')
@app.route('/submit_order', methods=['POST'])
def submit_order():
    # Step 1: Get the notification ID from your own registered endpoint
    try:
        # Modify this to use POST method instead of GET
        ipn_response = requests.post('http://127.0.0.1:5000/register_ipn_combined', json={})
