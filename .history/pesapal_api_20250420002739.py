...
CONSUMER_KEY = os.getenv('CONSUMER_KEY', 'YOUR_CONSUMER_KEY')  # Replace with your actual key or environment variable
CONSUMER_SECRET = os.getenv('CONSUMER_SECRET', 'YOUR_CONSUMER_SECRET')  # Replace with your actual secret or environment variable
