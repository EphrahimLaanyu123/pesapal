...
def make_pesapal_request(endpoint, data=None, method="POST", headers=None):
    ...
    token_response = requests.post(f"{BASE_URL}/Auth/RequestToken", json={
        "consumer_key": "Br9toGU3pWfpg21N3adIO2u95u2RTqXd",  # Replace with your actual consumer key
        "consumer_secret": "<S3AnVcFQ25XmEFRFLuV/Y/S5KG0=" # Replace with your actual consumer secret
    })
